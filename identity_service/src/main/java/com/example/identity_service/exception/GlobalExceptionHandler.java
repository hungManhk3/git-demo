...
//    }
    ...
    ResponseEntity<ApiResponse> handlingOptimisticLockException(OptimisticLockException e){
        ApiResponse apiResponse = new ApiResponse();
        apiResponse.setCode(ErrorCode.VERSION_UPDATE.getCode());
        apiResponse.setMessage(ErrorCode.VERSION_UPDATE.getMessage());
        return ResponseEntity.badRequest().body(apiResponse);
    }
